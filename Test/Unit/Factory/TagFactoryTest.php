...
namespace Lof\Opengraph\Test\Unit\Factory;
...
class TagFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Lof\Opengraph\Factory\TagFactory
     */
    private $tagFactory;
    ...
    public function setUp(): void
    {
        ...
        $this->tagFactory = $this->objectManager->get(\Lof\Opengraph\Factory\TagFactory::class);
    }
