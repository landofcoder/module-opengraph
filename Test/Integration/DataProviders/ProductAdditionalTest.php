...
class ProductAdditionalTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Lof\Opengraph\DataProviders\ProductAdditional
     */
    ...
    public function setUp(): void
    {
        ...
        $this->productAdditionalProvider = $this->objectManager->get(\Lof\Opengraph\DataProviders\ProductAdditional::class);
    }
